...
function getPasswordOptions() {
  ...
  let upperCaseYes = confirm ("Click ok to confirm to include uppercase Characters");
  ...
  let lowerCaseYes = confirm ("Click ok to confirm to include lowercase Characters");
